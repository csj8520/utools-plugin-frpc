<template>
  <el-table :data="tableData" stripe>
    ...
    <el-table-column label="开启加密" width="90px" align="center">
      <template #="{ row }"><el-checkbox :model-value="row.config.use_encryption" /></template>
    </el-table-column>
    <el-table-column label="开启压缩" width="90px" align="center">
      <template #="{ row }"><el-checkbox :model-value="row.config.use_compression" /></template>
    </el-table-column>
  ...
  <el-dialog v-model="showEdit" title="编辑" style="min-width: 500px">
    <el-form :model="editData" ref="form" label-width="100px">
      ...
      <template v-if="editData.config.type === 'http' || editData.config.type === 'https' || editData.config.type === 'tcpmux'">
      ...
      <template v-else-if="editData.config.type === 'stcp' || editData.config.type === 'sudp' || editData.config.type === 'xtcp'">
