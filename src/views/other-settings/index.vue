<template>
  <div class="h-full overflow-y-auto p-3">
    <el-form label-position="right" label-width="100px" :model="config" ref="form">
    ...
    <el-form label-position="right" label-width="100px" :model="custom" ref="customForm">
      <el-form-item label="保存后重启" prop="saveRestart">
        <el-checkbox v-model="custom.saveRestart" />
      </el-form-item>
      <el-form-item label="frpc路径" prop="">
        <el-input v-model="custom.frpcPath" :placeholder="`默认路径: ${frpc.frpcPath}`" />
      </el-form-item>
      <el-form-item label="配置路径" prop="">
        <el-input v-model="custom.configPath" :placeholder="`默认路径: ${frpc.configPath}`" />
      </el-form-item>
    </el-form>
  </div>
</template>
